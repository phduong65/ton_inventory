    ...
    <div class="modal-panel relative w-full max-w-sm p-6"
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:rgba(99,102,241,0.10)">
                    <i class="ph ph-ruler text-sm" style="color:#4f46e5"></i>
                </div>
                <h3 class="font-semibold text-base" style="color:var(--text-primary)">Thêm đơn vị tính</h3>
            </div>
        ...
        <form action="{{ route('units.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs" style="color:var(--text-muted)">Chữ in hoa, số, dấu gạch dưới. VD: LON, KG, M3</p>
                @error('code')
