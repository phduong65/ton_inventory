...
<head>
    ...
    <style>
        ...
        .ios .ts-wrapper .ts-control input {
            font-size: 16px !important
        }
    </style>
</head>
...
<body class="font-sans" x-data="{ mobileMenuOpen: false, sidebarCollapsed: false }">
    ...
    @php
        ...
        $activeModule = match (true) {
            str_starts_with($routeName, 'categories') ||
                ...
                str_starts_with($routeName, 'destinations')
                => 'danhmuc',
            str_starts_with($routeName, 'transactions') || str_starts_with($routeName, 'stocktakes') => 'phieu',
            str_starts_with($routeName, 'inventory') || str_starts_with($routeName, 'stock-ledger') => 'kho',
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex flex-col flex-1 min-w-0">
            ...
            {{-- Main Content --}}
            <main class="flex-1 overflow-y-auto" style="background: var(--surface-default)">
