...
<div x-show="openEdit" x-transition class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display:none">
    <div class="absolute inset-0 bg-black/50" @click="openEdit = false; editProduct = null"></div>
    <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-xl max-h-[92vh] overflow-y-auto">
        <div class="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
            ...
            <button @click="openEdit = false; editProduct = null" class="text-gray-400 hover:text-gray-600"><i class="bi bi-x-lg"></i></button>
        </div>
        ...
        <form :action="`/products/${editProduct.id}`" method="POST"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="min_stock" :value="editProduct.min_stock ?? ''" min="0" step="1" placeholder="0 = không cảnh báo"
                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
            </div>
            <div>
            ...
            <div class="flex justify-end gap-2 pt-2">
                <button type="button" @click="openEdit = false; editProduct = null"
