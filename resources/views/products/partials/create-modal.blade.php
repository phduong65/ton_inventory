        ...
        <div class="flex items-center justify-between p-5" style="border-bottom:1px solid var(--surface-border)">
            <div class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:rgba(99,102,241,0.10)">
                    <i class="ph ph-package text-sm" style="color:#4f46e5"></i>
                </div>
                <h3 class="font-semibold text-base" style="color:var(--text-primary)">Thêm sản phẩm</h3>
            </div>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="default_price" value="{{ old('default_price', 0) }}" min="0" step="1000" class="form-input">
                </div>
                <div>
                    ...
                    <input type="number" name="min_stock" value="{{ old('min_stock') }}" min="0" step="1" placeholder="0 = không cảnh báo" class="form-input">
                </div>
            </div>
            <div>
            ...
            <div class="flex justify-end gap-2 pt-1">
                ...
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white rounded-xl" style="background:#4f46e5" onmouseover="this.style.background='#4338ca'" onmouseout="this.style.background='#4f46e5'">Lưu sản phẩm</button>
            </div>
        </form>
    </div>
</div>
