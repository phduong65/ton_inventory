{{-- ── Desktop Sidebar (lg+) ──────────────────────────────────── --}}
<aside class="sidebar-base hidden lg:flex flex-col"
       :class="sidebarCollapsed ? 'sidebar-collapsed' : ''">

    {{-- Logo --}}
    <div class="flex items-center gap-3 px-3 py-3 border-b flex-shrink-0 overflow-hidden" style="border-color: var(--sidebar-border)">
        ...
        <div x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
            <p class="text-md font-bold leading-tight whitespace-nowrap" style="color:var(--text-primary)">Quản Lý Kho</p>
        </div>
    </div>
...
<div x-show="mobileMenuOpen"
    ...
    <div class="relative flex flex-col h-full overflow-hidden flex-shrink-0"
        ...
        {{-- Logo + Close --}}
        <div class="flex items-center justify-between px-3 py-3 border-b flex-shrink-0" style="border-color: var(--sidebar-border)">
